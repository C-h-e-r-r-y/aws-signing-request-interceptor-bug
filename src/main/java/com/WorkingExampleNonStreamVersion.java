...
public class WorkingExampleNonStreamVersion {
    public static void main(String[] args) throws Exception {
        ...
        final JsonGenerator generator = new JsonFactory().setCodec(mapper).createGenerator(baos);
        ...
        restClient.performRequest(
                ...
                new NStringEntity(baos.toString(StringUtils.UTF8.name())));
        restClient.close();
